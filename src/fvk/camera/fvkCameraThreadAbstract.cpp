...
bool fvkCameraThreadAbstract::open(int _device_id)
{
	...
	if (r)
	{
		if (m_width != -1) p_cam.set(CV_CAP_PROP_FRAME_WIDTH, m_width);
		if (m_height != -1) p_cam.set(CV_CAP_PROP_FRAME_HEIGHT, m_height);
...
cv::Size fvkCameraThreadAbstract::getResolution()
{
	...
	return cv::Size(static_cast<int>(p_cam.get(CV_CAP_PROP_FRAME_WIDTH)), static_cast<int>(p_cam.get(CV_CAP_PROP_FRAME_HEIGHT)));
}
int fvkCameraThreadAbstract::getWidth()
{
	return static_cast<int>(p_cam.get(CV_CAP_PROP_FRAME_WIDTH));
}
int fvkCameraThreadAbstract::getHeight()
{
	return static_cast<int>(p_cam.get(CV_CAP_PROP_FRAME_HEIGHT));
}
double fvkCameraThreadAbstract::getSharpness()
{
    return p_cam.get(CV_CAP_PROP_SHARPNESS);
}
double fvkCameraThreadAbstract::getAutoExposure()
{
    return p_cam.get(CV_CAP_PROP_AUTO_EXPOSURE);
}
double fvkCameraThreadAbstract::getFps()
{
    return p_cam.get(CV_CAP_PROP_FPS);
}
double fvkCameraThreadAbstract::getFrameCount()
{
	return p_cam.get(CV_CAP_PROP_FRAME_COUNT);
}
double fvkCameraThreadAbstract::getWhiteBalanceBlueU()
{
    return p_cam.get(CV_CAP_PROP_WHITE_BALANCE_BLUE_U);
}
double fvkCameraThreadAbstract::getWhiteBalanceRedV()
{
    return p_cam.get(CV_CAP_PROP_WHITE_BALANCE_RED_V);
}
double fvkCameraThreadAbstract::getFourCC()
{
    return p_cam.get(CV_CAP_PROP_FOURCC);
}

double fvkCameraThreadAbstract::getConvertToRGB()
{
	return p_cam.get(CV_CAP_PROP_CONVERT_RGB);
}
double fvkCameraThreadAbstract::getBrightness()
{
	return p_cam.get(CV_CAP_PROP_BRIGHTNESS);
}
double fvkCameraThreadAbstract::getContrast()
{
	return p_cam.get(CV_CAP_PROP_CONTRAST);
}
double fvkCameraThreadAbstract::getSaturation()
{
	return p_cam.get(CV_CAP_PROP_SATURATION);
}
double fvkCameraThreadAbstract::getHue()
{
	return p_cam.get(CV_CAP_PROP_HUE);
}
double fvkCameraThreadAbstract::getGain()
{
	return p_cam.get(CV_CAP_PROP_GAIN);
}
double fvkCameraThreadAbstract::getExposure()
{
	return p_cam.get(CV_CAP_PROP_EXPOSURE);
}
double fvkCameraThreadAbstract::getRectification()
{
	return p_cam.get(CV_CAP_PROP_RECTIFICATION);
}
double fvkCameraThreadAbstract::getFormat()
{
	return p_cam.get(CV_CAP_PROP_FORMAT);
}
double fvkCameraThreadAbstract::getMode()
{
	return p_cam.get(CV_CAP_PROP_MODE);
}
double fvkCameraThreadAbstract::getGamma()
{
	return p_cam.get(CV_CAP_PROP_GAMMA);
}
double fvkCameraThreadAbstract::getTemperature()
{
	return p_cam.get(CV_CAP_PROP_TEMPERATURE);
}
double fvkCameraThreadAbstract::getZoom()
{
	return p_cam.get(CV_CAP_PROP_ZOOM);
}
double fvkCameraThreadAbstract::getFocus()
{
	return p_cam.get(CV_CAP_PROP_FOCUS);
}
double fvkCameraThreadAbstract::getIsoSpeed()
{
	return p_cam.get(CV_CAP_PROP_ISO_SPEED);
}
double fvkCameraThreadAbstract::getBackLight()
{
	return p_cam.get(CV_CAP_PROP_BACKLIGHT);
}
double fvkCameraThreadAbstract::getPan()
{
	return p_cam.get(CV_CAP_PROP_PAN);
}
double fvkCameraThreadAbstract::getTilt()
{
	return p_cam.get(CV_CAP_PROP_TILT);
}
double fvkCameraThreadAbstract::getRoll()
{
	return p_cam.get(CV_CAP_PROP_ROLL);
}
double fvkCameraThreadAbstract::getTrigger()
{
	return p_cam.get(CV_CAP_PROP_TRIGGER);
}
double fvkCameraThreadAbstract::getTriggerDelay()
{
	return p_cam.get(CV_CAP_PROP_TRIGGER_DELAY);
}
