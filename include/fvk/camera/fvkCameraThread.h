...
public:
	...
	fvkCameraThread(const int device_index, const cv::Size& frame_size, fvkSemaphoreBuffer<cv::Mat>* buffer = nullptr);
	// Description:
	...
	void setSyncEnabled(const bool b);
	// Description:
...
protected:	
	...
	auto grab(cv::Mat& frame) -> bool override = 0;
